...
e2e/olm: ## Run e2e olm tests
	$(MAKE) e2e WHAT=operator-lifecycle-manager REGISTRY="docker-registry.default.svc:5000/olme2e" E2E_CATALOG_NS=openshift-marketplace E2E_INSTALL_NS=openshift-operator-lifecycle-manager E2E_TEST_NS=openshift-operators E2E_TIMEOUT=135m KUBECTL=oc
