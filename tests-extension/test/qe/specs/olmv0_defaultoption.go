...
var _ = g.Describe("[sig-operator][Jira:OLM] OLMv0 optional should", func() {
	...
	// Polarion ID: 83027
	g.It("PolarionID:83027-[OTP]-High-83027-Unnecessary churn with operatorgroup clusterrole management[Serial]", func() {
		dr := make(olmv0util.DescriberResrouce)
		itName := g.CurrentSpecReport().FullText()
		dr.AddIr(itName)
	...
	// Polarion ID: 70162
	g.It("PolarionID:70162-[OTP]-High-70162-Leverage Composable OpenShift feature to make OperatorLifecycleManager optional", func() {
	...
	// Polarion ID: 73201
	g.It("PolarionID:73201-[OTP]-[Skipped:Disconnected]High-73201-catalog pods do not recover from node failure [Disruptive][Serial]", func() {
	...
	// Polarion ID: 72192
	g.It("PolarionID:72192-[OTP]-Critical-72192-is not correctly refreshing operator catalogs due to IfNotPresent imagePullPolicy", g.Label("NonHyperShiftHOST"), g.Label("LEVEL0"), func() {
	...
	// Polarion ID: 72017
	g.It("PolarionID:72017-[OTP]-Medium-72017-pod panics when EnsureSecretOwnershipAnnotations runs", g.Label("NonHyperShiftHOST"), func() {
	...
	// Polarion ID: 72013
	g.It("PolarionID:72013-[OTP]-High-72013-Creating an OperatorGroup with 'Name: cluster' breaks the whole cluster", g.Label("LEVEL0"), func() {
	...
	// Polarion ID: 71996
	g.It("PolarionID:71996-[OTP]-High-71996-package-server-manager forbidden securityContext.seLinuxOptions [Serial]", g.Label("NonHyperShiftHOST"), func() {
	...
	// Polarion ID: 53771
	g.It("PolarionID:53771-[OTP]-[Slow][Skipped:Disconnected]Medium-53771-The certificate relating to operator-lifecycle-manager-packageserver isn't rotated after expired [Disruptive]", g.Label("NonHyperShiftHOST"), func() {
	...
	// Polarion ID: 68681
	g.It("PolarionID:68681-[OTP]-[Skipped:Disconnected]Medium-68681-pods with no 'controller: true' ownerReferences", g.Label("NonHyperShiftHOST"), func() {
	...
	// Polarion ID: 68679
	g.It("PolarionID:68679-[OTP]-[Skipped:Disconnected]Low-68679-catalogsource with invalid name is created", g.Label("NonHyperShiftHOST"), func() {
		dr := make(olmv0util.DescriberResrouce)
		itName := g.CurrentSpecReport().FullText()
		dr.AddIr(itName)
	...
	// Polarion ID: 59413
	g.It("PolarionID:59413-[OTP]-[Skipped:Disconnected]High-59413-Default CatalogSource aren't created in restricted mode [Serial]", g.Label("NonHyperShiftHOST"), func() {
		exutil.SkipIfDisableDefaultCatalogsource(oc)
		defaultCatalogSources := []string{"certified-operators", "community-operators", "redhat-marketplace", "redhat-operators"}
	...
	// Polarion ID: 59422
	g.It("PolarionID:59422-[OTP]-High-59422-package-server-manager does not stomp on changes made to packgeserver CSV", g.Label("NonHyperShiftHOST"), func() {
	...
	// Polarion ID: 59416
	g.It("PolarionID:59416-[OTP]-[Skipped:Disconnected]High-59416-Revert Catalog PSA decisions for 4.12 [Serial]", g.Label("NonHyperShiftHOST"), func() {
	...
	// Polarion ID: 53914
	g.It("PolarionID:53914-[OTP]-Medium-53914-OLM controller plug-in for openshift-* namespace labelling [Serial]", func() {
	...
	// Polarion ID: 53759
	g.It("PolarionID:53759-[OTP]-Medium-53759-Opeatorhub status shows errors after disabling default catalogSources [Disruptive]", g.Label("NonHyperShiftHOST"), func() {
	...
	// Polarion ID: 53758
	g.It("PolarionID:53758-[OTP]-[Skipped:Disconnected]High-53758-failed to recreate SA for the CatalogSource that without poll Interval", func() {
		buildPruningBaseDir := exutil.FixturePath("testdata", "olm")
		dr := make(olmv0util.DescriberResrouce)
		itName := g.CurrentSpecReport().FullText()
		dr.AddIr(itName)
	...
	// Polarion ID: 53740
	g.It("PolarionID:53740-[OTP]-Medium-53740-CatalogSource incorrect parsing validation", g.Label("NonHyperShiftHOST"), func() {
		buildPruningBaseDir := exutil.FixturePath("testdata", "olm")
		dr := make(olmv0util.DescriberResrouce)
		itName := g.CurrentSpecReport().FullText()
		dr.AddIr(itName)
	...
	// Polarion ID: 49687
	g.It("PolarionID:49687-[OTP]-Medium-49687-Make the marketplace operator optional", func() {
	...
	// Polarion ID: 49352
	g.It("PolarionID:49352-[OTP]-Medium-49352-SNO Leader election conventions for cluster topology", g.Label("NonHyperShiftHOST"), func() {
	...
	// Polarion ID: 49167
	g.It("PolarionID:49167-[OTP]-High-49167-fatal error", g.Label("NonHyperShiftHOST"), func() {
	...
	// Polarion ID: 25966
	g.It("PolarionID:25966-[OTP]-High-25966-offline mirroring support", func() {
		...
		if err != nil || strings.Contains(logs, "error") {
			e2e.Failf("Fail to mirror image to localhost:5000, error:%v", err)
		}
	})


	// Polarion ID: 48980
	g.It("PolarionID:48980-[OTP]-[Skipped:Disconnected]High-48980-oc adm catalog mirror image to local", func() {
		...
		if err != nil || strings.Contains(logs, "error mirroring image") {
			e2e.Failf("Fail to mirror image to local, error:%v", err)
		}
	...
	// Polarion ID: 46964
	g.It("PolarionID:46964-[OTP]-[Skipped:Disconnected]High-46964-Disable Copied CSVs Toggle [Serial]", func() {
		buildPruningBaseDir := exutil.FixturePath("testdata", "olm")
		dr := make(olmv0util.DescriberResrouce)
		itName := g.CurrentSpecReport().FullText()
		dr.AddIr(itName)
	...
	// Polarion ID: 43487
	g.It("PolarionID:43487-[OTP]-High-43487-3rd party Operator Catalog references change during an OCP Upgrade", func() {
	...
	// Polarion ID: 43271
	g.It("PolarionID:43271-[OTP]-Medium-43191-Medium-43271-Bundle Content Compression", func() {
		...
		sub.Create(oc, itName, dr)
		defer sub.DeleteCSV(itName, dr)
		olmv0util.NewCheck("expect", exutil.AsAdmin, exutil.WithoutNamespace, exutil.Compare, "Succeeded", exutil.Ok, []string{"csv", sub.StartingCSV, "-n", oc.Namespace(), "-o=jsonpath={.status.phase}"}).Check(oc)

		g.By("2) get its unpacking job name")
		installPlanName, err := oc.AsAdmin().WithoutNamespace().Run("get").Args("sub", "-n", oc.Namespace(), "sub-43191", "-o=jsonpath={.status.installplan.Name}").Output()
		if err != nil {
			e2e.Failf("Fail to get its InstallPlan Name: %v", err)
		}

		installPlanPath, err := oc.AsAdmin().WithoutNamespace().Run("get").Args("InstallPlan", "-n", oc.Namespace(), installPlanName, fmt.Sprintf("-o=jsonpath={.status.bundleLookups[?(@.identifier==\"%s\")].path}", sub.StartingCSV)).Output()
		...
		jobName := fmt.Sprintf("%x", sha256.Sum256([]byte(installPlanPath)))[:10]
		...
		extractCommand, err := oc.AsAdmin().WithoutNamespace().Run("get").Args("job", "-n", "openshift-marketplace", jobName, "-o=jsonpath={.spec.Template.spec.containers[?(@.Name==\"extract\")].command}").Output()
		if err != nil {
		...
		bData, err := oc.AsAdmin().WithoutNamespace().Run("get").Args("configmap", "-n", "openshift-marketplace", jobName, "-o=jsonpath={.binaryData}").Output()
		if err != nil {
	...
	// Polarion ID: 43101
	g.It("PolarionID:43101-[OTP]-[Skipped:Disconnected]High-43101-OLM blocks minor OpenShift upgrades when incompatible optional operators are installed", func() {
		architecture.SkipNonAmd64SingleArch(oc)
	...
	// Polarion ID: 43977
	g.It("PolarionID:43977-[OTP]-Medium-43977-OPENSHIFT_VERSIONS in assisted operator subscription does not propagate [Serial]", func() {
	...
	// Polarion ID: 43978
	g.It("PolarionID:43978-[OTP]-Medium-43978-Catalog pods don't report termination logs to catalog-operator", g.Label("NonHyperShiftHOST"), func() {
		exutil.SkipBaselineCaps(oc, "None")
	...
	// Polarion ID: 43803
	g.It("PolarionID:43803-[OTP]-Medium-43803-Only one of multiple subscriptions to the same package is honored", g.Label("NonHyperShiftHOST"), func() {
		exutil.SkipMissingQECatalogsource(oc)
	...
	// Polarion ID: 45411
	g.It("PolarionID:45411-[OTP]-High-45411-packageserver isn't following the OpenShift HA conventions", g.Label("NonHyperShiftHOST"), func() {
	...
	// Polarion ID: 43135
	g.It("PolarionID:43135-[OTP]-High-[Slow]NonPreRelease-43135-PackageServer respects single-node configuration [Disruptive]", g.Label("NonHyperShiftHOST"), func() {
		g.By("1) get the cluster infrastructure")
		infra, err := oc.AsAdmin().WithoutNamespace().Run("get").Args("infrastructures", "cluster", "-o=jsonpath={.status.infrastructureTopology}").Output()
		if err != nil {
			e2e.Failf("Fail to get the cluster infra")
	...
	// Polarion ID: 37826
	g.It("PolarionID:37826-[OTP]-[Skipped:Disconnected]High-37826-use an PullSecret for the private Catalog Source image [Serial]", func() {
		architecture.SkipNonAmd64SingleArch(oc)
		...
		ipName := olmv0util.GetResource(oc, exutil.AsAdmin, exutil.WithoutNamespace, "sub", sub.SubName, "-n", sub.Namespace, "-o=jsonpath={.status.installplan.Name}")
		...
		manifest := olmv0util.GetResource(oc, exutil.AsAdmin, exutil.WithoutNamespace, "installplan", "-n", sub.Namespace, ipName, "-o=jsonpath={.status.plan[0].resource.manifest}")
		...
		olmv0util.NewCheck("expect", exutil.AsAdmin, exutil.WithoutNamespace, exutil.Compare, "Succeeded", exutil.Ok, []string{"-n", "openshift-marketplace", "pods", "-l", fmt.Sprintf("job-name=%s", string(job[1])), "-o=jsonpath={.items[0].status.phase}"}).Check(oc)

	})


	// Polarion ID: 24028
	g.It("PolarionID:24028-[OTP]-High-24028-need to set priorityClassName as system-cluster-critical", g.Label("NonHyperShiftHOST"), func() {
	...
	// Polarion ID: 21548
	g.It("PolarionID:21548-[OTP]-High-21548-aggregates CR roles to standard admin view edit", func() {
	...
	// Polarion ID: 37442
	g.It("PolarionID:37442-[OTP]-High-37442-create a Conditions CR for each Operator it installs", func() {
		exutil.SkipMissingQECatalogsource(oc)
		...
		olmv0util.NewCheck("expect", exutil.AsAdmin, exutil.WithoutNamespace, exutil.Compare, "learn-operator", exutil.Ok, []string{"operatorcondition", "learn-operator.v0.0.3", "-n", oc.Namespace(), "-o=jsonpath={.spec.deployments[0]}"}).Check(oc)
		olmv0util.NewCheck("expect", exutil.AsAdmin, exutil.WithoutNamespace, exutil.Compare, "learn-operator.v0.0.3", exutil.Ok, []string{"deployment", "learn-operator", "-n", oc.Namespace(), "-o=jsonpath={.spec.Template.spec.containers[*].env[?(@.Name==\"OPERATOR_CONDITION_NAME\")].value}"}).Check(oc)
		// this learn-operator.v0.0.3 role should be owned by OperatorCondition
		olmv0util.NewCheck("expect", exutil.AsAdmin, exutil.WithoutNamespace, exutil.Compare, "OperatorCondition", exutil.Ok, []string{"role", "learn-operator.v0.0.3", "-n", oc.Namespace(), "-o=jsonpath={.metadata.ownerReferences[0].kind}"}).Check(oc)
		// this learn-operator.v0.0.3 role should be added to learn-operator SA
		olmv0util.NewCheck("expect", exutil.AsAdmin, exutil.WithoutNamespace, exutil.Compare, "learn-operator", exutil.Ok, []string{"rolebinding", "learn-operator.v0.0.3", "-n", oc.Namespace(), "-o=jsonpath={.subjects[0].Name}"}).Check(oc)
		...
		olmv0util.NewCheck("present", exutil.AsAdmin, exutil.WithoutNamespace, exutil.NotPresent, "", exutil.Ok, []string{"operatorcondition", "learn-operator.v0.0.3", "-n", oc.Namespace()}).Check(oc)
		olmv0util.NewCheck("present", exutil.AsAdmin, exutil.WithoutNamespace, exutil.NotPresent, "", exutil.Ok, []string{"role", "learn-operator.v0.0.3", "-n", oc.Namespace()}).Check(oc)
		olmv0util.NewCheck("present", exutil.AsAdmin, exutil.WithoutNamespace, exutil.NotPresent, "", exutil.Ok, []string{"rolebinding", "learn-operator.v0.0.3", "-n", oc.Namespace()}).Check(oc)

	})


	// Polarion ID: 37710
	g.It("PolarionID:37710-[OTP]-[Skipped:Disconnected]Medium-37710-supports the Upgradeable Supported Condition", func() {
		exutil.SkipMissingQECatalogsource(oc)
		g.By("1) Install the OperatorGroup in a random project")
		dr := make(olmv0util.DescriberResrouce)
		itName := g.CurrentSpecReport().FullText()
		...
		olmv0util.NewCheck("expect", exutil.AsAdmin, exutil.WithoutNamespace, exutil.Compare, "Upgradeable", exutil.Ok, []string{"operatorcondition", "learn-operator.v0.0.1", "-n", oc.Namespace(), "-o=jsonpath={.status.conditions[0].type}"}).Check(oc)
		olmv0util.NewCheck("expect", exutil.AsAdmin, exutil.WithoutNamespace, exutil.Compare, "False", exutil.Ok, []string{"operatorcondition", "learn-operator.v0.0.1", "-n", oc.Namespace(), "-o=jsonpath={.status.conditions[0].status}"}).Check(oc)
		...
		olmv0util.NewCheck("expect", exutil.AsAdmin, exutil.WithoutNamespace, exutil.Compare, "Pending", exutil.Ok, []string{"csv", "learn-operator.v0.0.2", "-n", oc.Namespace(), "-o=jsonpath={.status.phase}"}).Check(oc)
	...
	// Polarion ID: 37631
	g.It("PolarionID:37631-[OTP]-Medium-37631-Allow cluster admin to overwrite the OperatorCondition", func() {
		exutil.SkipMissingQECatalogsource(oc)
		g.By("1) Install the OperatorGroup in a random project")
		dr := make(olmv0util.DescriberResrouce)
		itName := g.CurrentSpecReport().FullText()
		...
		olmv0util.PatchResource(oc, exutil.AsAdmin, exutil.WithoutNamespace, "-n", oc.Namespace(), "operatorcondition", "learn-operator.v0.0.1", "-p", "{\"spec\": {\"overrides\": [{\"type\": \"Upgradeable\", \"status\": \"False\", \"reason\": \"upgradeIsNotSafe\", \"message\": \"Disable the upgrade\"}]}}", "--type=merge")
		...
		olmv0util.PatchResource(oc, exutil.AsAdmin, exutil.WithoutNamespace, "-n", oc.Namespace(), "operatorcondition", "learn-operator.v0.0.1", "-p", "{\"spec\": {\"overrides\": [{\"type\": \"Upgradeable\", \"status\": \"True\", \"reason\": \"upgradeIsNotSafe\", \"message\": \"Disable the upgrade\"}]}}", "--type=merge")
	...
	// Polarion ID: 33450
	g.It("PolarionID:33450-[OTP]-[Skipped:Disconnected]Medium-33450-Operator upgrades can delete existing CSV before completion", g.Label("NonHyperShiftHOST"), func() {
		architecture.SkipNonAmd64SingleArch(oc)
	...
	// Polarion ID: 37260
	g.It("PolarionID:37260-[OTP]-[Skipped:Disconnected]High-37260-should allow to create the default CatalogSource [Disruptive]", g.Label("NonHyperShiftHOST"), func() {
		exutil.SkipBaselineCaps(oc, "None")
		exutil.SkipIfDisableDefaultCatalogsource(oc)
	...
	// Polarion ID: 25922
	g.It("PolarionID:25922-[OTP]-Medium-25922-Support spec.config.volumes and volumemount in Subscription", func() {
		exutil.SkipMissingQECatalogsource(oc)
		buildPruningBaseDir := exutil.FixturePath("testdata", "olm")
		ogSingleTemplate := filepath.Join(buildPruningBaseDir, "operatorgroup.yaml")
		subTemplate := filepath.Join(buildPruningBaseDir, "olm-subscription.yaml")
	...
	// Polarion ID: 35631
	g.It("PolarionID:35631-[OTP]-Medium-35631-Remove OperatorSource API", func() {
		exutil.SkipBaselineCaps(oc, "None")
	...
	// Polarion ID: 33902
	g.It("PolarionID:33902-[OTP]-[Skipped:Disconnected]Medium-33902-Catalog Weighting", func() {
		architecture.SkipNonAmd64SingleArch(oc)
		buildPruningBaseDir := exutil.FixturePath("testdata", "olm")
		csImageTemplate := filepath.Join(buildPruningBaseDir, "catalogsource-image.yaml")
		ogSingleTemplate := filepath.Join(buildPruningBaseDir, "operatorgroup.yaml")
	...
	// Polarion ID: 32559
	g.It("PolarionID:32559-[OTP]-High-32559-catalog operator crashed", g.Label("NonHyperShiftHOST"), func() {
		buildPruningBaseDir := exutil.FixturePath("testdata", "olm")
	...
	// Polarion ID: 22070
	g.It("PolarionID:22070-[OTP]-[Skipped:Disconnected]Critical-22070-support grpc sourcetype [Serial]", g.Label("LEVEL0"), func() {
		buildPruningBaseDir := exutil.FixturePath("testdata", "olm")
		dr := make(olmv0util.DescriberResrouce)
		itName := g.CurrentSpecReport().FullText()
		dr.AddIr(itName)
		...
		sub.Create(oc, itName, dr)
		olmv0util.NewCheck("expect", exutil.AsAdmin, exutil.WithNamespace, exutil.Compare, "Succeeded", exutil.Ok, []string{"csv", sub.InstalledCSV, "-o=jsonpath={.status.phase}"}).Check(oc)
	...
	// Polarion ID: 20981
	g.It("PolarionID:20981-[OTP]-Medium-20981-contain the source commit id", g.Label("NonHyperShiftHOST"), func() {
	...
	// Polarion ID: 21126
	g.It("PolarionID:21126-[OTP]-Medium-21126-OLM Subscription status says CSV is installed when it is not", func() {
		exutil.SkipMissingQECatalogsource(oc)
		g.By("1) Install the OperatorGroup in a random project")
		dr := make(olmv0util.DescriberResrouce)
		itName := g.CurrentSpecReport().FullText()
		...
		olmv0util.NewCheck("expect", exutil.AsAdmin, exutil.WithoutNamespace, exutil.Compare, "", exutil.Ok, []string{"sub", "sub-21126", "-n", oc.Namespace(), "-o=jsonpath={.status.InstalledCSV}"}).Check(oc)
		// the state should be UpgradePending
		olmv0util.NewCheck("expect", exutil.AsAdmin, exutil.WithoutNamespace, exutil.Compare, "UpgradePending", exutil.Ok, []string{"sub", "sub-21126", "-n", oc.Namespace(), "-o=jsonpath={.status.state}"}).Check(oc)
		// the InstallPlan should not approved
		olmv0util.NewCheck("expect", exutil.AsAdmin, exutil.WithoutNamespace, exutil.Compare, "false", exutil.Ok, []string{"installplan", sub.GetIP(oc), "-n", oc.Namespace(), "-o=jsonpath={.spec.approved}"}).Check(oc)
