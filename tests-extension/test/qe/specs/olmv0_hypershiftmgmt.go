...
var _ = g.Describe("[sig-operator][Jira:OLM] OLMv0 on hypershift mgmt", g.Label("NonHyperShiftHOST"), func() {
	...
	g.It("PolarionID:45381-[OTP][Skipped:Disconnected]Support custom catalogs in hypershift", func() {
		var (
	...
	g.It("PolarionID:45408-[OTP][Skipped:Disconnected]Eliminate use of imagestreams in catalog management", func() {
