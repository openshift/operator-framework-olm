...
rm "${ROOT_DIR}/microshift-manifests/0000_50_olm_00-pprof-rbac.yaml"
rm "${ROOT_DIR}/microshift-manifests/0000_50_olm_00-pprof-config.yaml"
rm "${ROOT_DIR}/microshift-manifests/0000_50_olm_00-pprof-secret.yaml"
