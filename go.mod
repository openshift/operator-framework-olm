...
// CVE-2026-33186: OpenShift sustaining backport for Go 1.23 (upstream v1.79.3 requires Go 1.24).
// https://github.com/openshift-sustaining/grpc-go/releases/tag/v1.75.1-sec.1
