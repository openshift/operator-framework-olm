...
replace (
	github.com/googleapis/gnostic => github.com/google/gnostic v0.6.0
	github.com/grpc-ecosystem/grpc-health-probe => github.com/grpc-ecosystem/grpc-health-probe v0.4.25
	// controller runtime
	...
	helm.sh/helm/v3 => helm.sh/helm/v3 v3.14.0
