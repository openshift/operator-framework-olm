...
import (
	...
	operatorslisters "github.com/openshift/operator-framework-olm/staging/operator-lifecycle-manager/pkg/api/client/listers/operators/v1alpha1"
	registrygrpc "github.com/openshift/operator-framework-olm/staging/operator-lifecycle-manager/pkg/controller/registry/grpc"
	utillabels "github.com/openshift/operator-framework-olm/staging/operator-lifecycle-manager/pkg/lib/kubernetes/pkg/util/labels"
	...
	pkglisters "github.com/openshift/operator-framework-olm/staging/operator-lifecycle-manager/pkg/package-server/client/listers/operators/internalversion"
