//go:generate go run github.com/maxbrunsfeld/counterfeiter/v6 -o fakes/fake_registry_client.go ../../../../vendor/github.com/openshift/operator-framework-olm/staging/operator-registry/pkg/api.RegistryClient
