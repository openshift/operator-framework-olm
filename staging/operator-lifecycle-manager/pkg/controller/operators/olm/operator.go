...
import (
	...
	"github.com/openshift/operator-framework-olm/staging/operator-lifecycle-manager/pkg/controller/certs"
	"github.com/openshift/operator-framework-olm/staging/operator-lifecycle-manager/pkg/controller/install"
	"github.com/openshift/operator-framework-olm/staging/operator-lifecycle-manager/pkg/controller/operators/olm/overrides"
	"github.com/openshift/operator-framework-olm/staging/operator-lifecycle-manager/pkg/controller/registry/resolver"
	csvutility "github.com/openshift/operator-framework-olm/staging/operator-lifecycle-manager/pkg/lib/csv"
	...
	"github.com/openshift/operator-framework-olm/staging/operator-lifecycle-manager/pkg/lib/labeler"
	...
	"github.com/openshift/operator-framework-olm/staging/operator-lifecycle-manager/pkg/lib/proxy"
