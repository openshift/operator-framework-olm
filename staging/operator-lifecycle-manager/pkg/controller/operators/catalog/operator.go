...
import (
	...
	"github.com/openshift/operator-framework-olm/staging/api/pkg/operators/reference"
	...
	"github.com/openshift/operator-framework-olm/staging/operator-lifecycle-manager/pkg/controller/bundle"
	olmerrors "github.com/openshift/operator-framework-olm/staging/operator-lifecycle-manager/pkg/controller/errors"
	"github.com/openshift/operator-framework-olm/staging/operator-lifecycle-manager/pkg/controller/operators/catalog/subscription"
	"github.com/openshift/operator-framework-olm/staging/operator-lifecycle-manager/pkg/controller/registry"
	"github.com/openshift/operator-framework-olm/staging/operator-lifecycle-manager/pkg/controller/registry/grpc"
	...
	"github.com/openshift/operator-framework-olm/staging/operator-lifecycle-manager/pkg/lib/event"
	index "github.com/openshift/operator-framework-olm/staging/operator-lifecycle-manager/pkg/lib/index"
	...
	"github.com/openshift/operator-framework-olm/staging/operator-lifecycle-manager/pkg/lib/scoped"
	sharedtime "github.com/openshift/operator-framework-olm/staging/operator-lifecycle-manager/pkg/lib/time"
